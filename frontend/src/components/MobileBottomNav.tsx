...
export function MobileBottomNav() {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-40 border-t border-gray-200 bg-surface/95 backdrop-blur-sm lg:hidden"
          ...
          return (
            <li key={tab.to} className="flex-1">
              <NavLink
                ...
                className={({ isActive }) =>
                  [
                    "flex min-h-11 flex-col items-center justify-center gap-0.5 rounded-lg px-1 py-1 text-[10px] font-medium transition-colors",
                    isActive
                      ? "text-accent"
