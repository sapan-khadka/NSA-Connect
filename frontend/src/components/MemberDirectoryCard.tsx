...
import { getMemberInitials } from "../lib/member-talents";
...
export function MemberDirectoryRow({ member, to }: MemberDirectoryRowProps) {
  ...
  return (
    <Link
      to={to}
      className="group grid grid-cols-1 gap-2 px-4 py-3 transition-colors hover:bg-gray-50 sm:grid-cols-[minmax(0,2fr)_minmax(0,1.5fr)_minmax(0,1.5fr)_auto] sm:items-center sm:gap-4 lg:px-6"
    >
