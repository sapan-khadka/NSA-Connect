  ...
  return (
    ...
    >
      <button
        ...
        className="min-h-11 rounded-full bg-primary px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-primary-hover"
      >
        + Log transaction
      </button>
      ...
      <Link
        ...
        className="inline-flex min-h-11 items-center gap-2 rounded-full border border-gray-200 bg-surface-card px-4 py-2.5 text-sm font-medium text-foreground transition hover:border-accent hover:bg-accent/5"
      >
        Review approvals
