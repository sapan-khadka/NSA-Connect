...
export function FinancePage() {
  ...
  const budgetEvents =
    budgetState.status === "ready" ? budgetState.events : [];
  const budgetLoading = budgetState.status === "loading";
  const budgetError =
  ...
  return (
    <div className="finance-page">
      <header className="finance-page-header">
        ...
        <label className="finance-page-semester">
          ...
          {FINANCE_TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={
                  isActive
                    ? "finance-page-tab is-active"
                    : "finance-page-tab"
                }
              >
                {tab.label}
                {showBadge ? (
                  <span className="finance-page-tab-badge">
      ...
      <div className="finance-page-body">
          ...
          <div className="finance-tab-stack" data-testid="finance-books">
            ...
            <section className="finance-panel" aria-label="Transactions">
              <div className="finance-books-toolbar">
                <label className="finance-books-event-filter">
                  <span className="finance-books-event-label">Event</span>
                  <select
                ...
                {booksEventId != null ? (
                  <button
                    ...
                    className="finance-books-clear-filter"
                  >
                    Clear event filter
                  </button>
                ) : null}
            ...
            <section
              ...
              aria-labelledby="finance-breakdown-heading"
            >
              <div className="finance-panel-head">
                <h2
                  id="finance-breakdown-heading"
                  className="finance-panel-title"
                >
                  Transaction breakdown
                </h2>
                <p className="finance-panel-copy">
                  Income and expense by event for this period
                </p>
              </div>
              <FinanceTransactionBreakdown
                summary={summary}
        ...
        {canViewTreasury && activeTab === "dues" ? (
          <div className="finance-tab-stack" data-testid="finance-dues">
            {semester === "all" ? (
              <p className="finance-dues-hint">
                Showing dues for {formatSemesterLabel(duesSemester)}. Choose a
                semester above to switch terms.
              </p>
            ) : null}
            <DuesDashboard
