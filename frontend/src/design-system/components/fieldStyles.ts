...
export const fieldControlClassName =
  "w-full rounded-[10px] border border-gray-200 bg-surface-card px-3 py-3 text-base text-foreground shadow-none transition duration-200 placeholder:text-label focus:border-primary focus:outline-none focus:ring-2 focus:ring-brand-soft disabled:cursor-not-allowed disabled:bg-surface-muted disabled:opacity-60 sm:py-2 sm:text-sm";
