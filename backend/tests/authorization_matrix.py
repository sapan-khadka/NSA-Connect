...
ENDPOINT_AUTH_RULES: tuple[EndpointAuthRule, ...] = (
    ...
    EndpointAuthRule(
        "GET",
        "/api/v1/me/notepad",
        "List own personal notepad notes",
        "board",
        "get_current_member",
        object_rules="Board+ only; notes scoped to owner in service",
    ),
    EndpointAuthRule(
        "POST",
        "/api/v1/me/notepad",
        "Create personal notepad note",
        "board",
        "get_current_member",
        object_rules="Board+ only; notes scoped to owner in service",
    ),
    EndpointAuthRule(
        "PATCH",
        "/api/v1/me/notepad/{note_id}",
        "Update personal notepad note",
        "board",
        "get_current_member",
        object_rules="Board+ only; own notes only in service",
        skip_role_probe=True,
    ),
    EndpointAuthRule(
        "DELETE",
        "/api/v1/me/notepad/{note_id}",
        "Delete personal notepad note",
        "board",
        "get_current_member",
        object_rules="Board+ only; own notes only in service",
        skip_role_probe=True,
    ...
    EndpointAuthRule(
        "PATCH",
        "/api/v1/discussions/messages/{message_id}",
    ...
    EndpointAuthRule(
        "POST",
        "/api/v1/discussions/rooms/{room_id}/avatar",
        "Upload discussion room avatar",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ),
    ...
    EndpointAuthRule(
        "POST",
        "/api/v1/discussions/rooms/{room_id}/members",
        "Add discussion room members",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ),
    EndpointAuthRule(
        "DELETE",
        "/api/v1/discussions/rooms/{room_id}/members/{member_id}",
        "Remove discussion room member",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ),
    EndpointAuthRule(
        ...
        "Toggle personal discussion archive",
        "member",
        "get_current_member",
    ),
    EndpointAuthRule(
    ...
    EndpointAuthRule(
        "DELETE",
        "/api/v1/media/albums/{album_id}/items/{item_id}",
        "Delete media album item",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ),
    EndpointAuthRule(
        "POST",
        "/api/v1/media/albums/{album_id}/download",
        "Download media album zip",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ),
    ...
    EndpointAuthRule(
        "GET",
        "/api/v1/event-suggestions/{suggestion_id}",
        "Get suggestion",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ...
    EndpointAuthRule(
        "PATCH",
        "/api/v1/event-suggestions/{suggestion_id}/review",
        "Board-review suggestion",
        "board",
        "require_board",
    ),
    EndpointAuthRule(
        "POST",
        "/api/v1/event-suggestions/{suggestion_id}/convert",
    ...
    EndpointAuthRule(
        "GET",
        "/api/v1/event-suggestions/{suggestion_id}/comments",
        "List suggestion comments",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ),
    ...
    EndpointAuthRule(
        "DELETE",
        "/api/v1/event-suggestions/{suggestion_id}/comments/{comment_id}",
    ...
    EndpointAuthRule(
        "GET",
        "/api/v1/event-suggestions/{suggestion_id}/board-comments",
        "List board suggestion comments",
        "board",
        "require_board",
    ),
    EndpointAuthRule(
        "POST",
        "/api/v1/event-suggestions/{suggestion_id}/board-comments",
        "Create board suggestion comment",
        "board",
        "require_board",
    ),
    EndpointAuthRule(
        "DELETE",
        "/api/v1/event-suggestions/{suggestion_id}/board-comments/{comment_id}",
        "Delete board suggestion comment",
        "board",
        "require_board",
    ),
    EndpointAuthRule(
        "PUT",
        "/api/v1/event-suggestions/{suggestion_id}/interest",
        "Set suggestion interest",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ),
    ...
    EndpointAuthRule(
        "GET",
        "/api/v1/event-suggestions/{suggestion_id}/community-insight",
        "Suggestion community insight",
        "board",
        "require_board",
    ),
    EndpointAuthRule(
        "GET",
        "/api/v1/event-suggestions/{suggestion_id}/activity",
        "Suggestion activity",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ...
    EndpointAuthRule(
        "GET",
        "/api/v1/event-suggestions/{suggestion_id}/related",
        "Related suggestions",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ...
    EndpointAuthRule(
        "GET",
        "/api/v1/event-suggestions/{suggestion_id}/polls",
        "List suggestion polls",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ),
    EndpointAuthRule(
        "GET",
        "/api/v1/event-suggestions/{suggestion_id}/poll",
        "Get suggestion poll",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ...
    EndpointAuthRule(
        "POST",
        "/api/v1/event-suggestions/{suggestion_id}/polls",
        "Create suggestion poll (alias)",
        "board",
        "require_board",
    ),
    EndpointAuthRule(
        "PUT",
        "/api/v1/event-suggestions/{suggestion_id}/poll/vote",
        "Vote on suggestion poll",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ),
    EndpointAuthRule(
        "PUT",
        "/api/v1/event-suggestions/{suggestion_id}/polls/{poll_id}/vote",
        "Vote on suggestion poll by id",
        "member",
        "get_current_member",
        skip_role_probe=True,
    ),
    EndpointAuthRule(
        "POST",
        "/api/v1/event-suggestions/{suggestion_id}/poll/close",
        "Close suggestion poll",
        "board",
        "require_board",
    ),
    EndpointAuthRule(
        "POST",
        "/api/v1/event-suggestions/{suggestion_id}/polls/{poll_id}/close",
        "Close suggestion poll by id",
        "board",
        "require_board",
    ),
    # Event tasks
